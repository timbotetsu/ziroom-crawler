...
import timbo.homebrew.ziroomcrawler.domain.BCAttachment;
import timbo.homebrew.ziroomcrawler.domain.BCNotification;
import timbo.homebrew.ziroomcrawler.domain.ResponseWrapper;
...
public class Crawler {
    ...
    private BCNotification constructNewRoomNotification(Room room) {
        ...
        attachment.setTitle(room.getName());
        attachment.setText(room.getDescription());
        attachment.setColor(BLUE_COLOR);
        attachment.setUrls(Arrays.asList(room.getPhoto()));
    ...
    private BCNotification constructPriceChangeNotification(Room oldR, Room newR, boolean raise) {
        ...
        attachment.setUrls(Arrays.asList(newR.getPhoto()));
